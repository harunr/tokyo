! function () {
        ...
        p = function (t) {
            ...
            return o(i, f), l(i, [{
                ...
                value: function () {
                    ...
                    this.els = [], this.el.querySelectorAll("[data-" + this.name + "]").forEach(function (t, e) {
                        var i = t.dataset[h.name + "Class"] || h.class,
                            ...
                            o = t.dataset[h.name + "Repeat"],
                            a = t.dataset[h.name + "Call"];
                        o = "false" != o && (null != o || h.repeat);
                        var r = h.getRelativeOffset(l),
                            c = {
                                el: t,
                                id: e,
                                class: i,
                ...
                value: function () {
                    var l = this;
                    this.els.forEach(function (t, e) {
                        var i = t.el.getBoundingClientRect().top + l.instance.scroll.y,
    ...
    var g = function () {
        ...
        for (var i, s, n = function (t) {
            ...
            for (var o in i = Object(arguments[l])) m.call(i, o) && (n[o] = i[o]);
            if (y) {
                s = y(i);
                for (var a = 0; a < s.length; a++) v.call(i, s[a]) && (n[s[a]] = i[s[a]])
            }
        }
        return n
    };
    ...
    t.prototype = {
        ...
        off: function (t, e) {
            var i = this.e || (this.e = {}),
                ...
                n = [];
            if (s && e)
                for (var l = 0, o = s.length; l < o; l++) s[l].fn !== e && s[l].fn._ !== e && n.push(s[l]);
                    ...
                    this.els = [], this.parallaxElements = [], this.sections.forEach(function (t, b) {
                        k.sections[b].el.querySelectorAll("[data-".concat(k.name, "]")).forEach(function (t, e) {
                            var i, s, n = t.dataset[k.name + "Class"] || k.class,
                                ...
                                o = t.dataset[k.name + "Call"],
                                a = t.dataset[k.name + "Position"],
                                r = t.dataset[k.name + "Delay"],
                            ...
                            if (h) {
                                ...
                                y = ((p = (i += window.innerHeight) + s.offsetHeight - window.innerHeight - t.offsetHeight - m) - i) / 2 + i
                            }
                            l = "false" != l && (null != l || k.repeat);
                            var v = [0, 0];
                            if (d)
                                for (var g = 0; g < d.length; g++) "string" == typeof d[g] ? d[g].includes("%") ? v[g] = parseInt(d[g].replace("%", "") * k.windowHeight / 100) : v[g] = parseInt(d[g]) : v[g] = d[g];
                            var w = {
                                el: t,
                                id: e,
                                class: n,
